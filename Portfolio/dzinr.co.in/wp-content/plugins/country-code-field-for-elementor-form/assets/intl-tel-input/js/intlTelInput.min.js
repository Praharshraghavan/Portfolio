...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        var x = (l, t) => {
            ...
            P = (l, t, e, i) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let n of S(t)) !M.call(l, n) && n !== e && _(l, n, {
                        get: () => t[n],
                        enumerable: !(i = A(t, n)) || i.enumerable
                    });
                return l
            };
        var H = l => P(_({}, "__esModule", {
            value: !0
        }), l);
        var B = {};
        x(B, {
        ...
        var O = 0,
            ...
            f = l => l.replace(/\D/g, ""),
            D = (l = "") => l.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(),
            k = l => {
                let t = f(l);
                if (t.charAt(0) === "1") {
                    let e = t.substr(1, 3);
            ...
            b = class {
                ...
                constructor(t, e = {}) {
                    this.id = O++, this.a = t, this.c = null, this.d = Object.assign({}, N, e), this.e = !!t.getAttribute("placeholder")
                }
                _init() {
                    this.d.useFullscreenPopup && (this.d.fixDropdownWidth = !1), this.d.separateDialCode && (this.d.allowDropdown = !0, this.d.nationalMode = !1), !this.d.showFlags && !this.d.separateDialCode && (this.d.nationalMode = !1), this.d.useFullscreenPopup && !this.d.dropdownContainer && (this.d.dropdownContainer = document.body), this.isRTL = !!this.a.closest("[dir=rtl]"), this.d.i18n = { ...E,
                        ...this.d.i18n
                    };
                ...
                _b() {
                    this._d(), this._d2(), this._d0(), this.d.countryOrder && (this.d.countryOrder = this.d.countryOrder.map(t => t.toLowerCase())), this._sortCountries()
                }
                _sortCountries() {
                    this.p.sort((t, e) => {
                        let {
                ...
                _f() {
                    ...
                    t && (c += " iti--allow-dropdown"), i && (c += " iti--show-flags"), n && (c += ` ${n}`), u || (c += " iti--inline-dropdown");
                    let g = h("div", {
                        class: c
                    });
                    if (this.a.parentNode ? .insertBefore(g, this.a), t || i) {
                        this.k = h("div", {
                            class: "iti__country-container"
                        }, g), this.selectedCountry = h("button", {
                            type: "button",
                        ...
                        if (this.l = h("div", null, p), this.selectedCountryA11yText = h("span", {
                                class: "iti__a11y-text"
                            }, this.l), this.a.disabled ? this.selectedCountry.setAttribute("aria-disabled", "true") : this.selectedCountry.setAttribute("tabindex", "0"), t && (this.u = h("div", {
                                class: "iti__arrow",
                                "aria-hidden": "true"
                            }, p)), e && (this.t = h("div", {
                                class: "iti__selected-dial-code"
                            }, this.selectedCountry)), t) {
                            let m = a ? "" : "iti--flexible-dropdown-width";
                            if (this.dropdownContent = h("div", {
                                    ...
                                    autocomplete: "off"
                                }, this.dropdownContent), this.searchResultsA11yText = h("span", {
                                    class: "iti__a11y-text"
                                }, this.dropdownContent), this.countryList = h("ul", {
                                    class: "iti__country-list",
                                    id: `iti-${this.id}__country-listbox`,
                                    role: "listbox",
                                    "aria-label": d.countryListAriaLabel
                                }, this.dropdownContent), this._g(this.p, "iti__standard"), this._p4(), r) {
                                let v = "iti iti--container";
                                u ? v += " iti--fullscreen-popup" : v += " iti--inline-dropdown", this.dropdown = h("div", {
                                    class: v
                                }), this.dropdown.appendChild(this.dropdownContent)
                            } else this.k.appendChild(this.dropdownContent)
                        }
                    }
                    if (g.appendChild(this.a), s) {
                        let p = this.a.getAttribute("name") || "",
                            m = s(p);
                        m.phone && (this.hiddenInput = h("input", {
                            type: "hidden",
                            name: m.phone
                        }), g.appendChild(this.hiddenInput)), m.country && (this.hiddenInputCountry = h("input", {
                            type: "hidden",
                            name: m.country
                        }), g.appendChild(this.hiddenInputCountry))
                    }
                }
                _g(t, e) {
                    for (let i = 0; i < t.length; i++) {
                        ...
                        let r = "";
                        this.d.showFlags && (r += `<div class='iti__flag-box'><div class='iti__flag iti__${n.iso2}'></div></div>`), r += `<span class='iti__country-name'>${n.name}</span>`, r += `<span class='iti__dial-code'>+${n.dialCode}</span>`, s.insertAdjacentHTML("beforeend", r)
                    }
                }
                _h(t = !1) {
                    ...
                    if (r && !a) this._v(s);
                        ...
                        d && this._y(d, !0) ? this._z(d) : r && a ? this._z("us") : this._z()
                    }
                    s && this._u(s)
                }
                _i() {
                ...
                _i3() {
                    this.d.utilsScript && !o.utils ? o.documentReady() ? o.loadUtils(this.d.utilsScript) : window.addEventListener("load", () => {
                        o.loadUtils(this.d.utilsScript)
                    }) : this.i0(), this.d.initialCountry === "auto" && !this.s.iso2 ? this._i4() : this.h()
                }
                _i4() {
                    o.autoCountry ? this.handleAutoCountry() : o.startedLoadingAutoCountry || (o.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                        e && this._y(e, !0) ? (o.autoCountry = e, setTimeout(() => y("handleAutoCountry"))) : (this._h(!0), y("rejectAutoCountryPromise"))
                    }, () => {
                ...
                _j() {
                    ...
                    this._a12 = s => {
                        ...
                        let r = s && s.data && /[^+0-9]/.test(s.data),
                            a = s && s.inputType === "insertFromPaste" && this.a.value;
                        if (r || a && !t ? n = !0 : /[^+0-9]/.test(this.a.value) || (n = !1), e && !n) {
                            let u = this.a.selectionStart || 0,
                                c = this.a.value.substring(0, u).replace(/[^+0-9]/g, "").length,
                                g = s && s.inputType === "deleteContentForward",
                                p = this._9(),
                                m = z(c, p, u, g);
                            this.a.value = p, this.a.setSelectionRange(m, m)
                        }
                    }, this.a.addEventListener("input", this._a12), (t || i) && (this._handleKeydownEvent = s => {
                        if (s.key && s.key.length === 1 && !s.altKey && !s.ctrlKey && !s.metaKey) {
                            if (i && s.key === "+") {
                                s.preventDefault(), this._n(), this.searchInput.value = "+", this._p3("", !0);
                                return
                            }
                            if (t) {
                                let r = this.a.selectionStart === 0 && s.key === "+",
                                    a = /^[0-9]$/.test(s.key),
                                    u = r || a,
                                    d = this._6(),
                                    c = o.utils.getCoreNumber(d, this.s.iso2),
                                    g = this.maxCoreNumberLength && c.length >= this.maxCoreNumberLength,
                                    p = this.a.value.substring(this.a.selectionStart, this.a.selectionEnd),
                                    m = /\d/.test(p);
                                (!u || g && !m) && s.preventDefault()
                            }
                        }
                ...
                _n() {
                    ...
                    t && (this.dropdownContent.style.width = `${this.a.offsetWidth}px`), this.dropdownContent.classList.remove("iti__hide"), this.selectedCountry.setAttribute("aria-expanded", "true"), this._o();
                    let e = this.countryList.firstElementChild;
                    e && (this._x(e, !1), this.countryList.scrollTop = 0), this.searchInput.focus(), this._p(), this.u.classList.add("iti__arrow--up"), this._trigger("open:countrydropdown")
                }
                _o() {
                ...
                _p() {
                    ...
                    this._a2 = () => {
                        t || this._2(), t = !1
                    }, document.documentElement.addEventListener("click", this._a2), this._a3 = n => {
                        ["ArrowUp", "ArrowDown", "Enter", "Escape"].includes(n.key) && (n.preventDefault(), n.stopPropagation(), n.key === "ArrowUp" || n.key === "ArrowDown" ? this._q(n.key) : n.key === "Enter" ? this._r() : n.key === "Escape" && this._2())
                    ...
                    }, this.searchInput.addEventListener("input", this._a7), this.searchInput.addEventListener("click", n => n.stopPropagation())
                }
                _p3(t, e = !1) {
                    let i = !0;
                    ...
                    for (let s = 0; s < this.p.length; s++) {
                        let r = this.p[s],
                            a = D(r.name),
                            u = `+${r.dialCode}`;
                        if (e || a.includes(n) || u.includes(n) || r.iso2.includes(n)) {
                            let d = r.nodeById[this.id];
                ...
                _u(t) {
                    let e = t;
                    if (this.d.formatOnDisplay && o.utils && this.s) {
                        let i = this.d.nationalMode || e.charAt(0) !== "+" && !this.d.separateDialCode,
                            {
                                NATIONAL: n,
                                INTERNATIONAL: s
                            } = o.utils.numberFormat,
                            r = i ? n : s;
                        e = o.utils.formatNumber(e, this.s.iso2, r)
                    }
                ...
                _v(t) {
                    ...
                    if (r) {
                        let d = this.q[f(r)],
                            c = d.indexOf(this.s.iso2) !== -1 && a.length <= r.length - 1;
                        if (!(n === "1" && k(a)) && !c) {
                    ...
                    } else i.charAt(0) === "+" && a.length ? u = "" : (!i || i === "+") && !this.s.iso2 && (u = this.j);
                ...
                _x(t, e) {
                    ...
                    if (i && (i.classList.remove("iti__highlight"), i.setAttribute("aria-selected", "false")), this.c = t, this.c) {
                        ...
                        this.selectedCountry.setAttribute("aria-activedescendant", n), this.searchInput.setAttribute("aria-activedescendant", n)
                    }
                    e && this.c.focus()
                }
                _y(t, e) {
                ...
                _z(t) {
                    ...
                    if (this.s = t ? this._y(t, !1) || {} : {}, this.s.iso2 && (this.j = this.s.iso2), this.l) {
                        let r = "",
                            a = "";
                        t && i ? (r = `iti__flag iti__${t}`, a = `${this.s.name} +${this.s.dialCode}`) : (r = "iti__flag iti__globe", a = n.noCountrySelected), this.l.className = r, this.selectedCountryA11yText.textContent = a
                    }
                    if (this._z3(t, e), e) {
                        let r = this.s.dialCode ? `+${this.s.dialCode}` : "";
                        this.t.innerHTML = r;
                ...
                _updateMaxLength() {
                    ...
                    if (t && o.utils)
                        if (this.s.iso2) {
                            let n = o.utils.numberType[e],
                                s = o.utils.getExampleNumber(this.s.iso2, !1, n, !0),
                                r = s;
                            for (; o.utils.isPossibleNumber(s, this.s.iso2, i);) r = s, s += "0";
                            let a = o.utils.getCoreNumber(r, this.s.iso2);
                ...
                _0() {
                    ...
                    if (o.utils && s) {
                        let r = o.utils.numberType[e],
                            a = this.s.iso2 ? o.utils.getExampleNumber(this.s.iso2, i, r) : "";
                        a = this._7(a), typeof n == "function" && (a = n(a, this.s)), this.a.setAttribute("placeholder", a)
                    }
                }
                _1(t) {
                ...
                _9() {
                    let t = this._6(),
                        e = o.utils ? o.utils.formatNumberAsYouType(t, this.s.iso2) : t,
                        {
                            dialCode: i
                        } = this.s;
                ...
                handleAutoCountry() {
                    this.d.initialCountry === "auto" && o.autoCountry && (this.j = o.autoCountry, this.a.value || this.setCountry(this.j), this.h())
                }
                handleUtils() {
                    o.utils && (this.a.value && this._u(this.a.value), this.s.iso2 && (this._0(), this._updateMaxLength())), this.i0()
                }
                destroy() {
                    ...
                    this._a14 && t && t.removeEventListener("submit", this._a14), this.a.removeEventListener("input", this._a12), this._handleKeydownEvent && this.a.removeEventListener("keydown", this._handleKeydownEvent), this.a.removeAttribute("data-intl-tel-input-id");
                    let e = this.a.parentNode;
                    e ? .parentNode ? .insertBefore(this.a, e), e ? .parentNode ? .removeChild(e), delete o.instances[this.id]
                }
                getExtension() {
                    return o.utils ? o.utils.getExtension(this._6(), this.s.iso2) : ""
                }
                getNumber(t) {
                    if (o.utils) {
                        let {
                        ...
                        return o.utils.formatNumber(this._6(), e, t)
                    }
                    return ""
                }
                getNumberType() {
                    return o.utils ? o.utils.getNumberType(this._6(), this.s.iso2) : -99
                }
                ...
                getValidationError() {
                    if (o.utils) {
                        ...
                        return o.utils.getValidationError(this._6(), t)
                    }
                    return -99
                }
                isValidNumber() {
                    let t = this._6();
                    return /\p{L}/u.test(t) ? !1 : o.utils ? o.utils.isPossibleNumber(t, this.s.iso2, this.d.validationNumberType) : null
                }
                isValidNumberPrecise() {
                    let t = this._6();
                    return /\p{L}/u.test(t) ? !1 : o.utils ? o.utils.isValidNumber(t, this.s.iso2) : null
                }
                setCountry(t) {
                    let e = t.toLowerCase();
            ...
            j = l => !o.utils && !o.startedLoadingUtilsScript ? (o.startedLoadingUtilsScript = !0, new Promise((t, e) => {
                import ( /* webpackIgnore: true */ l).then(({
                    default: i
                }) => {
                    o.utils = i, y("handleUtils"), t(!0)
                }).catch(() => {
                    y("rejectUtilsScriptPromise"), e()
                })
            })) : null,
            o = Object.assign((l, t) => {
                let e = new b(l, t);
                return e._init(), l.setAttribute("data-intl-tel-input-id", e.id.toString()), o.instances[e.id] = e, e
            }, {
                defaults: N,
